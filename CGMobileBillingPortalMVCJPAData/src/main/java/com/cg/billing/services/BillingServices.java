...
public interface BillingServices {
	...
	Bill getMobileBillDetails(int customerID, long mobileNo, String billMonth) throws CustomerDetailsNotFoundException,
			PostpaidAccountNotFoundException, InvalidBillMonthException, BillDetailsNotFoundException;

	Customer acceptCustomerDetails(Customer customer);
	Plan acceptPlanDetails(Plan plan);
